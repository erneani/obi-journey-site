...
<html>
    ...
    <body>
        ...
        <div id="show-prova" class="content scaffold-show" role="main">
            ...
            <f:display bean="prova" />
            <g:form resource="${this.prova}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.prova}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
