...
<html>
    ...
    <body>
        ...
        <div id="show-gerente" class="content scaffold-show" role="main">
            ...
            <f:display bean="gerente" />
            <g:form resource="${this.gerente}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.gerente}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
