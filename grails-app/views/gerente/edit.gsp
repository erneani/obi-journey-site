...
<html>
    ...
    <body>
        ...
        <div id="edit-gerente" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.gerente}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.gerente}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.gerente}" method="PUT">
                <g:hiddenField name="version" value="${this.gerente?.version}" />
                <fieldset class="form">
                    <f:all bean="gerente"/>
                </fieldset>
